...
#ifdef DEBUG
	#define fsb_info(...) pr_info("INFO\t"  __FILE__ ":" LINESTR ":\t" __VA_ARGS__ )
	#define fsb_warn(...) pr_warn("WARN\t"  __FILE__ ":" LINESTR ":\t" __VA_ARGS__ )
	#define fsb_err(...)  pr_err ("ERROR\t" __FILE__ ":" LINESTR ":\t" __VA_ARGS__ )
	#define fsb_dbg(...)  pr_info("DEBUG\t" __FILE__ ":" LINESTR ":\t" __VA_ARGS__ )
#else
	#define fsb_info(...) pr_info ( "failsafeboot: " __VA_ARGS__ )
	#define fsb_warn(...) pr_warn ( "failsafeboot: " __VA_ARGS__ )
	#define fsb_err(...)  pr_err  ( "failsafeboot: " __VA_ARGS__ )
	#define fsb_dbg(...)  pr_debug( "failsafeboot: " __VA_ARGS__ )
#endif
